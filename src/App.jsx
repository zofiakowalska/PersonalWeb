    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <nav className="fixed top-6 left-6 z-50 flex items-center gap-4">
        ...
        <a
          ...
          className="bg-white/90 backdrop-blur-md rounded-full shadow-lg px-4 py-2.5 text-[#0077b5] hover:text-[#005885] hover:bg-white transition-all border border-gray-200 flex items-center gap-2 font-medium"
          aria-label="LinkedIn"
        >
